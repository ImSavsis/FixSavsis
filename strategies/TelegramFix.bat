...
set LIST_TITLE=ZAPRET: Telegram Fix
...
--filter-udp=50000-65535 --hostlist="%LIST_PATH%" --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-cutoff=d3 --dpi-desync-repeats=6 --new ^
