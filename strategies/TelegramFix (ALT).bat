...
set LIST_TITLE=ZAPRET: Telegram Fix ALT
set LIST_PATH=%~dp0..\engine\lists\list-telegram.txt
...
--filter-udp=50000-65535 --hostlist="%LIST_PATH%" --dpi-desync=fake,tamper --dpi-desync-any-protocol --dpi-desync-cutoff=n5 --dpi-desync-repeats=9
